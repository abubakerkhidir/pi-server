...
export default function ChatHeader({ username, onSettingsClick, onLogout, currentModel, onModelSelect }: ChatHeaderProps) {
  return (
    <div className="header">
      ...
      <div className="header-right">
        ...
        <button className="icon-btn" onClick={onSettingsClick} title="Settings">⚙</button>
